...
drugHeritability <- function(rep.data, concentration_um){
  ...
  if(1 %in% no.reps$n){
    ...
    H2.est <- suppressMessages(as.data.frame(H2.bootstrapping.calc(d = rep.data, nreps = 100, boot = T))) %>%
      dplyr::mutate(drug = unique(rep.data$drug),
                  concentration = concentration_um) %>%
      `colnames<-`(c("H2", "lower", "upper", "drug", "concentration_um"))
...
all.dat <- processed.toxin09A$summarized_processed %>%
  ...
  dplyr::full_join(processed.toxin22A$summarized_processed) 
...
silverH2 <- purrr::map2(drug.data.nested.reps$data,
            ...
            drugHeritability)
silverH2.df <- do.call(rbind, silverH2)
options(scipen = 9999999)
ggplot(silverH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(silverH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
cadmiumH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
cadmiumH2.df <- do.call(rbind, cadmiumH2)
options(scipen = 9999999)
ggplot(cadmiumH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(cadmiumH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
copperH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
copperH2.df <- do.call(rbind, copperH2)
options(scipen = 9999999)
ggplot(copperH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(copperH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
nickelH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
nickelH2.df <- do.call(rbind, nickelH2)
options(scipen = 9999999)
ggplot(nickelH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(nickelH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
paraquatH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
paraquatH2.df <- do.call(rbind, paraquatH2)
options(scipen = 9999999)
ggplot(paraquatH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(paraquatH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
zincH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
zincH2.df <- do.call(rbind, zincH2)
options(scipen = 9999999)
ggplot(zincH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(zincH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
pyraclostrobinH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
pyraclostrobinH2.df <- do.call(rbind, pyraclostrobinH2)
options(scipen = 9999999)
ggplot(pyraclostrobinH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(pyraclostrobinH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
aldicarbH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
aldicarbH2.df <- do.call(rbind, aldicarbH2)
options(scipen = 9999999)
ggplot(aldicarbH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(aldicarbH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
chlorfenapyrH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
chlorfenapyrH2.df <- do.call(rbind, chlorfenapyrH2)
options(scipen = 9999999)
ggplot(chlorfenapyrH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(chlorfenapyrH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
methomylH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
methomylH2.df <- do.call(rbind, methomylH2)
options(scipen = 9999999)
ggplot(methomylH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(methomylH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
mercuryH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
mercuryH2.df <- do.call(rbind, mercuryH2)
options(scipen = 9999999)
ggplot(mercuryH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(mercuryH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
tppH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
tppH2.df <- do.call(rbind, tppH2)
options(scipen = 9999999)
ggplot(tppH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(tppH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
arsenicH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
arsenicH2.df <- do.call(rbind, arsenicH2) %>%
  dplyr::filter(H2 != "NA") %>%
...
options(scipen = 9999999)
ggplot(arsenicH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(arsenicH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
carbarylH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
carbarylH2.df <- do.call(rbind, carbarylH2)
options(scipen = 9999999)
ggplot(carbarylH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(carbarylH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
carboxinH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
carboxinH2.df <- do.call(rbind, carboxinH2)
options(scipen = 9999999)
ggplot(carboxinH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(carboxinH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
chlorpyrifosH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
chlorpyrifosH2.df <- do.call(rbind, chlorpyrifosH2) %>%
  dplyr::filter(H2 != "NA") %>%
  dplyr::mutate(H2 = as.numeric(H2),
                lower = as.numeric(lower),
                upper = as.numeric(upper))
options(scipen = 9999999)
ggplot(chlorpyrifosH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(chlorpyrifosH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
leadH2.df <- do.call(rbind, leadH2) %>%
  dplyr::filter(H2 != "NA") %>%
  dplyr::mutate(H2 = as.numeric(H2),
                lower = as.numeric(lower),
                upper = as.numeric(upper))
options(scipen = 9999999)
ggplot(leadH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(leadH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```
...
atrazineH2 <- purrr::map2(drug.data.nested.reps$data,
            drug.data.nested.reps$concentration_um,
            drugHeritability)
atrazineH2.df <- do.call(rbind, atrazineH2)
options(scipen = 9999999)
ggplot(atrazineH2.df, mapping = aes(x = as.factor(concentration_um), y = H2)) + 
  theme_bw() + 
  geom_pointrange(mapping = aes(ymin = lower, ymax = upper)) + 
  ylim(c(0,1)) +
  geom_hline(yintercept = 0.3, linetype = 3) + 
  # theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) + 
  labs(title = unique(atrazineH2.df$drug), 
       x = "Concentration (µM)",
       y = bquote(H^2))
```

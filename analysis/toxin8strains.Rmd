...
## EC Estimates
```{r DRC metrics, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
### EC10
```{r EC10 plots, fig.height=7, fig.width=10, message=FALSE, warning=FALSE, echo=FALSE, include=FALSE}
selected.EC.est.dat %>%
  dplyr::filter(fraction == "EC10",
...
```{r fungicides, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
drug.classes %>%
...
```{r pyrethroids, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
drug.classes %>%
...
```{r organophosphate, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
drug.classes %>%
...
```{r metal, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
drug.classes %>%
...
```{r herb, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
drug.classes %>%
